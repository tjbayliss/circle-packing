...
var aleph = {
  ...
  taxonomyArray:
    [] /* initialisation of array to store selected filter values in */,
  ...
  .on("click", function () {
    if (d3.selectAll(".aleph-controls").classed("aleph-closeControls")) {
      d3.selectAll(".aleph-controls")
        .classed("aleph-closeControls", false)
        .classed("aleph-openControls", true);
    } else {
      d3.selectAll(".aleph-controls")
        .classed("aleph-closeControls", true)
        .classed("aleph-openControls", false);
    }
...
function onload() {
  ...
  d3.selectAll(".aleph-chart")
    ...
    .attr(
      "height",
      /* 900 */ vis.height - aleph.margin.top - aleph.margin.bottom
    );
...
function windowResize() {
  ...
  if (root) {
    ...
    d3.selectAll(".aleph-map-image").attr(
      "width",
...
function submitSelection() {
  ...
  svg = d3
    ...
    .attr(
      "transform",
      "translate(" + aleph.margin.left + "," + aleph.margin.top + ")"
    );
  ...
  d3.selectAll(".aleph-bannerSVGBase")
    ...
    .attr(
      "transform",
      "translate(" + /* aleph.margin.left */ 130 + "," + 65 + ")"
    );
...
function addLevelLabels(levelsToShow) {
  ...
  d3.selectAll(".aleph-tree-levelLabels-g")
    ...
    .attr("class", function (d, i) {
      return (
        "aleph-tree-levelLabels-branch-g aleph-tree-levelLabels-branch-g-" + i
      );
    })
    ...
    .on("click", function (d, i) {
      ...
      if (aleph.displayToSelectedLevel < aleph.lastSelectedLevelToDisplayTo) {
        ...
        aleph.displayToSelectedLevel > aleph.lastSelectedLevelToDisplayTo
      ) {
        expandChart();
    ...
    .attr("class", function (d, i) {
      return (
        "aleph-tree-levelLabel" +
        " " +
        CharacterToCharacter(aleph.taxonomyArray[i], " ", "_")
      );
    })
    .attr("x", 0)
    .attr("y", 0)
...
function submitURL() {
  ...
  url = url
    .replace("http://HMI-technologySelector.co.uk?", "")
    .replace(":true", "");
